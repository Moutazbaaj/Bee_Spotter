...
struct ProfileView: View {
    ...
    @StateObject var reportsViewModel = ReportsViewModel.shared  // ViewModel for managing reports
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                // Section for SOS profile navigation
                Section {
                    NavigationLink(destination: SosView(profileViewModel: profileViewModel)) {
                        HStack {
                            Spacer()
                            Text("SOS Profile")
                ...
                // Section for reports history navigation
                Section {
                    NavigationLink(destination: ReportsListView(reportsViewModel: reportsViewModel)) {
                        HStack {
                            Spacer()
        ...
        .onAppear {
            ...
            profileViewModel.fetchSosProfile()  // Fetch SOS profile information
            reportsViewModel.fetchUserReportList()  // Fetch the list of user reports
        }
    }
}
